...
| 경로 | 분류·역할 |
|---|---|
| `docs/planning/design/`, `docs/archive/design-selection/`, `docs/archive/home-update/` | 화면·디자인 자료 |
| `docs/development/backend-plans/`, `docs/development/backend-implementation/` | 백엔드 계약·운영·검증 자료 |
| 나머지 `docs/` 하위 폴더 | 공통 정책·기획·작업 분담·인수인계·과거 기록 |
...
문서와 검증 증거는 기존 링크를 유지하기 위해 `docs/`에 보존한다. 과거 보고서에 등장하는 이전 코드 경로는 아래 대응표로 읽는다.
