...
> Source of truth: the **Home tab** of the live app (`src/App.tsx` home view, `Header`, `EventBanner`/`EventCarousel`, `AppointmentReminders`, `CategoryGrid`, `BottomNav`, `CarouselBar`).
