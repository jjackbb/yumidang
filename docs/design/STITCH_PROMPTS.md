...
2. 첫 프롬프트로 `docs/design/DESIGN.md` 전체를 붙여 넣고 끝에 한 줄을 붙인다: `Use this as the design system for every screen in this project. Reply "OK" only.`
...
5. 완성되면 화면 이름(예: `S01_둘러보기.png`)으로 스크린샷과 HTML/코드를 내보내 `docs/design/stitch-export/`에 넣는다 → Antigravity 적용 단계로 넘긴다.
