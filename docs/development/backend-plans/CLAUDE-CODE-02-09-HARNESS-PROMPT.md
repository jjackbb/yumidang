...
3. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/02-login.md`
4. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/02-login-HANDOFF.md`
5. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/03-browse-posts.md`
6. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/04-view-profile.md`
7. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/05-join-request.md`
8. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/06-matching-chat.md`
9. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/07-final-match.md`
10. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/08-complete-appointment.md`
11. `/Users/b/Documents/Antigravity/yumidang/docs/development/backend-plans/09-mutual-review.md`
12. 현재 `src/`, `supabase/`, `tests/`, `package.json`, Git 변경 상태

우선순위는 **이 프롬프트와 최신 사용자 결정 → 번호별 계획 문서 → 현재 코드와 원격 관찰 → 최신 루트 HANDOFF → 과거 프로토타입 문서**다. `docs/archive/overnight/`, 과거 분석 문서, 데모 데이터는 참고 자료일 뿐 새 백엔드의 계약으로 복사하지 마.
...
docs/development/backend-implementation/
...
Notion 도구나 인증이 없으면 구현을 멈추지 말고 `docs/development/backend-implementation/NOTION-UPDATE.md`에 같은 내용을 작성해. 이 경우 Notion을 수정했다고 쓰지 마.
