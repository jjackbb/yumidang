...
const MESSAGES: Record<string, string> = {
  ...
  request_declined_history: '작성자가 이전 신청을 거절한 공고에는 다시 신청할 수 없어요.',
  ...
  completion_unavailable: '취소·불발·이의 검토 중인 동행은 완료 처리할 수 없어요.',
  dispute_window_closed: '완료 알림 후 24시간의 이의제기 기간이 종료됐어요.',
  dispute_not_allowed: '직접 완료 처리한 사람은 이 완료에 이의를 제기할 수 없어요.',
  dispute_already_open: '이미 이 동행의 이의제기가 접수됐어요.',
  invalid_dispute_reason: '이의제기 사유를 2~500자로 입력해 주세요.',
  ...
  review_paused_by_dispute: '이의제기 검토 중에는 평가 작성과 공개가 일시 중지돼요.',
  review_unavailable: '불발·취소된 동행은 일반 상호평가 대상이 아니에요.',
};
