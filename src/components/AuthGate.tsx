type AuthGateStatus = 'loading' | 'authenticated' | 'anonymous' | 'error';

export function AuthGate({ status, error, onRetry, onLogin }: { status: AuthGateStatus; error: string | null; onRetry: () => void; onLogin: () => void }) {
