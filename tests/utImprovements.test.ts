...
const migrationPath = new URL('../supabase/migrations/20260917122744_ut_notifications_and_discovery.sql', import.meta.url);
const sql = readFileSync(migrationPath, 'utf8');
const indexMigrationPath = new URL('../supabase/migrations/20260917141449_notifications_join_request_index.sql', import.meta.url);
